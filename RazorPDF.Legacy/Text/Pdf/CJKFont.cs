...
namespace RazorPDF.Legacy.Text.Pdf
{
    ...
    internal class CJKFont : BaseFont
    {
        ...
        internal static TagProperties cjkFonts = new TagProperties();
        internal static TagProperties cjkEncodings = new TagProperties();
        ...
        private static void LoadProperties()
        {
            ...
            lock (allFonts)
            {
                ...
                {
                    cjkFonts = new TagProperties();
                    cjkEncodings = new TagProperties();
                }
