...
namespace RazorPDF.Legacy.Text.Pdf.Codec.Wmf {
    public class MetaFont : MetaObject {
        ...
        public BaseFont Font {
            get {
                if (font != null)
                    return font;
                var ff2 = FontFactory.GetFont(faceName, BaseFont.CP1252, true, 10, ((italic != 0) ? Text.Font.ITALIC : 0) | ((bold != 0) ? Text.Font.BOLD : 0));
                font = ff2.BaseFont;
                if (font != null)
                    return font;
                string fontName;
