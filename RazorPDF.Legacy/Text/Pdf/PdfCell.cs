...
namespace RazorPDF.Legacy.Text.Pdf {
     ...
     *
     * @see     RazorPDF.Legacy.Text.Rectangle.
     * @see     Legacy.Text.Cell
     * @see     PdfLine
     * @see     PdfTable
     */
    ...
    public class PdfCell : Rectangle {
        ...
        */
        private float GetBorderWidthInside(int side) {
            ...
            if (useBorderPadding) {
                switch (side) {
                    case RazorPDF.Legacy.Text.Rectangle.LEFT_BORDER:
                        width = BorderWidthLeft;
                        break;

                    case RazorPDF.Legacy.Text.Rectangle.RIGHT_BORDER:
                        width = BorderWidthRight;
                        break;

                    case RazorPDF.Legacy.Text.Rectangle.TOP_BORDER:
