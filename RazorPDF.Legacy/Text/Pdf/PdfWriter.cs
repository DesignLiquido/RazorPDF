...
using RazorPDF.Legacy.Misc.Util.Collections;
using RazorPDF.Legacy.Misc.Util;
using RazorPDF.Legacy.Text.Pdf.Events;
using RazorPDF.Legacy.Text.Pdf.Interfaces;
using RazorPDF.Legacy.Text.Pdf.Intern;
using RazorPDF.Legacy.Text.Pdf.Collection;
 ...
 */
using RazorPDF.Legacy.Text.Xml.Xmp;
