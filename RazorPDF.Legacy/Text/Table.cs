...
using RazorPDF.Legacy.Misc.Drawing;
...
namespace RazorPDF.Legacy.Text{
    ...
    /// <seealso cref="T:Legacy.Text.Element"/>
    ...
    public class Table : Rectangle, ILargeElement {
        ...
        */
        ...
        public void DeleteColumn(int column) {
            ...
            Array.Copy(widths, 0, newWidths, 0, column);
            Array.Copy(widths, column + 1, newWidths, column, columns - column);
            Widths = newWidths;
            Array.Copy(widths, 0, newWidths, 0, columns);
            widths = newWidths;
            Row row;
            int size = rows.Count;
