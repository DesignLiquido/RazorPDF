using System;
using System.IO;
using RazorPDF.Legacy.Text.Rtf.Document.Output;
using RazorPDF.Legacy.Text.Rtf.HeaderFooter;
using RazorPDF.Legacy.Text.Rtf.List;
using ST = RazorPDF.Legacy.Text.Rtf.Style;
using RazorPDF.Legacy.Text.Rtf.Style;
using HF = RazorPDF.Legacy.Text.Rtf.HeaderFooter;

//using RazorPDF.Legacy.Text.Rtf;
/*
...
namespace RazorPDF.Legacy.Text.Rtf.Document {
    ...
    */
    public class RtfDocumentHeader : RtfElement {
        ...
        */
        private Legacy.Text.HeaderFooter header = null;
        /**
        * The current RtfHeaderFooterGroup for the footer
        */
        private Legacy.Text.HeaderFooter footer = null;
