...
using RazorPDF.Legacy.Text.Rtf.Parser;
using RazorPDF.Legacy.Text.Rtf.Parser.CtrlWords;
using RazorPDF.Legacy.Text.Rtf.Parser.Properties;
/*
 ...
 */
namespace RazorPDF.Legacy.Text.Rtf.Parser.Destinations {
    /**
    ...
    */
    public sealed class RtfDestinationDocument : RtfDestination, IRtfPropertyListener {
        ...
        */
        private Legacy.Text.Document doc = null;
