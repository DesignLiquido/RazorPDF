...
using System.Text;
using RazorPDF.Legacy.Text.Rtf.Direct;
using RazorPDF.Legacy.Text.Rtf.Document;
using RazorPDF.Legacy.Text.Rtf.Parser.CtrlWords;
/*
 ...
 */
using RazorPDF.Legacy.Text.Rtf.Parser.Destinations;

namespace RazorPDF.Legacy.Text.Rtf.Parser {
    ...
    */
    ...
    public class RtfParser {
        ...
        */
        private Legacy.Text.Document document = null;
        /**
        ...
        *       On I/O errors.
        */
        public void ConvertRtfDocument(Stream readerIn, Legacy.Text.Document doc) {
    ...
    //      System.out.Println("RtfCtrlWordMgr used approximately " + df.Format((startFree - endFree) / 1024) + "k");
        ...
        */
        ...
        public static void OutputDebug(object doc, int groupLevel, String str) {
            ...
            else if (doc is Legacy.Text.Document)
            {
                try {
                    ((Legacy.Text.Document)doc).Add(new RtfDirectContent("\n" + spaces + str));
    ...
    //      }
        ...
        *       Returns the object rtfDoc.
        */
        public Legacy.Text.Document GetDocument() {
