...
using FD = RazorPDF.Legacy.Text.Rtf.Field;
 ...
 */
namespace RazorPDF.Legacy.Text.Rtf.HeaderFooter {
    ...
    */
    public class RtfHeaderFooter : Legacy.Text.HeaderFooter, IRtfBasicElement
    {
        ...
        */
        protected internal RtfHeaderFooter(RtfDocument doc, Legacy.Text.HeaderFooter headerFooter, int type, int displayAt) : base(new Phrase(""), false)  {
            this.document = doc;
            this.type = type;
        ...
        */
        public void SetAlignment(int alignment) {
            ...
            for (int i = 0; i < this.content.Length; i++) {
                ...
                } else if (this.content[i] is Legacy.Text.Table) {
                    ((Legacy.Text.Table) this.content[i]).Alignment = alignment;
