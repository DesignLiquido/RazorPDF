...
using RazorPDF.Legacy.Text.Rtf.Field;
using RazorPDF.Legacy.Text.Rtf.Graphic;
using RazorPDF.Legacy.Text.Rtf.List;
using RazorPDF.Legacy.Text.Rtf.Table;
using RazorPDF.Legacy.Text.Rtf.Text;
/*
        ...
        public IRtfBasicElement[] MapElement(IElement element) {
            ...
            switch (element.Type) {
                ...
                case Element.CREATIONDATE:
                    ...
                    break;
                case Element.LIST:
                    rtfElements.Add(new RtfList(rtfDoc, (Legacy.Text.List) element));
                    break;
                ...
                case Element.TABLE:
                    try {
                        rtfElements.Add(new RtfTable(rtfDoc, (Legacy.Text.Table)element));
                    }
